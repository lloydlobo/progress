<script lang="ts">
	...
	const handleLogin = async () => {
		try {
			...
			alert('Check your email fo the login link');
		} catch (error: any) {
...
<form action="" on:submit|preventDefault={handleLogin} class="row flex-center flex">
	<!--  -->
	<div class="form-widget grid grid-cols-6">
		<h1 class="form-title">Login</h1>
		<p class="form-description">Sign in via magic link with your email below</p>
		<div class="form-input-email">
			<input type="email" placeholder="Your email" bind:value={email} class="inputField" />
		</div>
