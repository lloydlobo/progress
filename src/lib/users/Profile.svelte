<script lang="ts">
	...
	import Avatar from '$lib/users/Avatar.svelte';

	// import type { Action } from 'svelte/types/runtime/action'; // https://stackoverflow.com/questions/72244111/what-is-a-return-type-of-a-use-directive
	...
	async function getProfile() {
		try {
			...
			if (!error) throw new Error('No error defined');
			alert(error.message);
		} finally {
			loading = false;
